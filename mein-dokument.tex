% ju 05-Dec-24 mein-dokument.tex
...
\begin{figure}
\centering
\includegraphics[width=0.6\linewidth,keepaspectratio]{images/mindmap/Mindmap-Git.pdf}
%\floatnotes{}
%\label{fig:}
\caption{Was ist Git?}
\end{figure}
...
\item
  ...
  \textcite{europa:2022:ab1_4}.
\item
  Tabellenbuch Fahrzeugtechnik \textcite{bell:2021:tabellenbuch}.
\item
  Technische Mathematik Fahrzeugtechnik \textcite{bell:2022:mathematik}.
\item
  Motormanagement Sensoren \textcite{schneehage:2021:sensoren}.
\item
  Claude \textcite{claudeAI:2024:ki}.
\item
...
\begin{figure}
\centering
\includegraphics[width=0.6\linewidth,keepaspectratio]{images/mindmap/Mindmap.pdf}
%\floatnotes{}
%\label{fig:}
...
\begin{figure}
\centering
\includegraphics[width=0.6\linewidth,keepaspectratio]{images/mindmap/Mindmap-Python.pdf}
%\floatnotes{}
%\label{fig:}
